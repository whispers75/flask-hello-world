...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "8D4A2"  # Playfab Title Id
        self.SecretKey: str = "885GUX47RACR86AU9DMFJHEG1SCC1QFAHG9196MSF3H7TH4XZ1"  # Playfab Secret Key
        self.ApiKey: str = "OC|9603426539781323|ea8d493e33279c4e90a36857e1354580"  # App Api Key (Oculus/Graph API)

    def get_auth_headers(self):
        return {"content-type": "application/json", "X-SecretKey": self.SecretKey}

settings = GameInfo()
app = Flask(__LegacyTagFlaskName__)
    ...
    return """
        <html>
            ...
            <body style="font-family: 'Inter', sans-serif; background: linear-gradient(to bottom, #004d00, #00cc00); color: white; text-align: center; padding: 50px;">
                ...
                <img src="https://imgs.search.brave.com/jFJFuh8Z0OdlPTs_uwN6VRQzeqSs2w3gofwP2SZzfvY/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly93d3cu/cGl4ZWxzdGFsay5u/ZXQvd3AtY29udGVu/dC91cGxvYWRzL2lt/YWdlczYvVGhlLWJl/c3QtTmJhLVlvdW5n/Ym95LVdhbGxwYXBl/ci1IRC01MDZ4NjIw/LmpwZw" alt="if u see this text it dont work" style="max-width: 500px; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3); display: block; margin: 30px auto;">
...
def titledata():
    response_data = {
        ...
        "MOTD": "Welcome to Legacy Tag We are in the KiteFest 24/25 and if you join the discord you can get 5 free cosmetics Discord link https://discord.gg/9fZdB7yjhx we also do Staff con where you might be able to meet your fav staff member!",
